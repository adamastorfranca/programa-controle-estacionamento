...
public class VeiculoRepositorio {
	...
	public void backup() {
		...
		listaVeiculosCadastrados.add(new Veiculo(TiposDeVeiculos.CARRO, Marcas.CITROEN, "AAA-0004", new Visitante("Dono4", "000.000.000-16", TiposDePessoas.procurarOpcao(3), 99999996, MotivosDaVisita.procurarOpcao(4))));
		...
		listaVeiculosCadastrados.add(new Veiculo(TiposDeVeiculos.MOTO, Marcas.HONDA, "AAA-0008", new Visitante("Dono8", "000.000.000-20", TiposDePessoas.procurarOpcao(3), 99999995, MotivosDaVisita.procurarOpcao(5))));
		...
		listaVeiculosCadastrados.add(new Veiculo(TiposDeVeiculos.VAN, Marcas.PEUGEOT, "AAA-0012", new Visitante("Dono12", "000.000.000-24", TiposDePessoas.procurarOpcao(3), 99999994, MotivosDaVisita.procurarOpcao(6))));
		...
		listaVeiculosCadastrados.add(new Veiculo(TiposDeVeiculos.ONIBUS, Marcas.CHEVROLET, "AAA-0016", new Visitante("Dono16", "000.000.000-28", TiposDePessoas.procurarOpcao(3), 99999993, MotivosDaVisita.procurarOpcao(7))));
	}
